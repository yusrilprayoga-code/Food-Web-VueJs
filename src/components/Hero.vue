<template>
    <div>
        ...
        <div class="container mt-4">
            ...
            <div class="row">
                <div v-for="category in categories" :key="category.idCategory" class="col-md-4 mb-3">
                    <div class="card">
                        <img :src="category.strCategoryThumb" class="card-img-top" alt="Category Image" width="100%">
                        <div class="card-body">
